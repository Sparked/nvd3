...
(function() {
  ...
  */
        ...
        function getTooltipContainer(newContent) {
            ...
            if (container.node() === null) {
                ...
                container = body.append("div")
                    .attr("class", "nvtooltip left " + (classes? classes: "xy-tooltip"))
                    .attr("id",id)
                    ;
            }
  ...
  nv.tooltip.calcTooltipPosition = function(pos, gravity, dist, container) {
            ...
            // First clearing the old class name
            container.className = container.className.replace("top", "");
            container.className = container.className.replace("bottom", "");
            container.className = container.className.replace("left", "");
            container.className = container.className.replace("right", "");
            ...
            switch (gravity) {
              case 'e':
                ...
                container.className = container.className + " right";
                break;
              case 'w':
                left = pos[0] + dist;
                top = pos[1] - (height / 2);
              ...
              case 'n':
                ...
                if (tTop + height > scrollTop + windowHeight) top = scrollTop + windowHeight - tTop + top - height;
                container.className = container.className + " top";
                break;
              case 's':
                left = pos[0] - (width / 2);
                ...
                container.className = container.className + " bottom";
                break;
              case 'none':
                left = pos[0];
                top = pos[1] - dist;
